// Adapted from projects/yandecode/packages/retrieval/src/service/hybrid-retriever.ts: DocumentRepository/ChunkRecord now come from the ported persistence layer.
import type { ChunkRecord, DocumentRepository } from '../../persistence/documents-repository.js';
