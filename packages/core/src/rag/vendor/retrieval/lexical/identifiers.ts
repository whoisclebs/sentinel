// Adapted from projects/yandecode/packages/retrieval/src/lexical/identifiers.ts: splitIdentifier now comes from the ported fts-query.ts.
import { splitIdentifier } from '../../persistence/fts-query.js';
