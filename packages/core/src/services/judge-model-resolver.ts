...
export function resolveJudgeModel(): BaseChatModel {
  ...
  throw new Error(
    'No LLM provider configured for the documentation judge: set ANTHROPIC_API_KEY, or extend resolveJudgeModel() with another @langchain/core BaseChatModel provider.',
  );
}
